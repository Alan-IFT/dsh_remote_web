#!/usr/bin/env node
import { decodePairingCode, encodePairingCode, fingerprint, hashToken } from "./headers-BshunupR.js";
import { defaultCredentialPath, openCredentials, openStatus, stateDir, statusPath } from "./config-bmEE_rfg.js";
import { DEFAULT_RELAY_OPTIONS, RelayStore, startRelay } from "./server-DmhMez_u.js";
