#!/usr/bin/env node
import { decodePairingCode, encodePairingCode, fingerprint, hashToken } from "./headers-B1leP-qx.js";
import { defaultCredentialPath, openCredentials, openStatus, stateDir, statusPath } from "./config-LzdmX5ds.js";
import { DEFAULT_RELAY_OPTIONS, RelayStore, startRelay } from "./server-Ct6qyfT6.js";
